...
from openpilot.selfdrive.car.subaru.values import DBC, GLOBAL_GEN2, PREGLOBAL_CARS, HYBRID_CARS, STEER_RATE_LIMITED, CanBus, CarControllerParams, SubaruFlags, GLOBAL_CARS_SNG
...
class CarController:
  def __init__(self, dbc_name, CP, VM):
    ...
    self.param_s = Params()
    self.has_epb = not self.param_s.get_bool("SubaruManualParkingBrakeSng")
